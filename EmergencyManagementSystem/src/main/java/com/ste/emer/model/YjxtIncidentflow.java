 ...
 */
@Alias("Incidentflow")
public class YjxtIncidentflow implements java.io.Serializable{
    private String incidentFlowID;
    ...
    public YjxtIncidentflow(String incidentFlowID, String incidentID, String planID, String incidentName,
                            int incidentType, int incidentState, Date createDate, int incidentOrigin, Date startTime,
                            Date endTime, int incidentLevel, String incidentAddress, String incidentDescription,
                            int placeType, String incidentOther, String incidentX, String incidentY, int isWatchCCTV,
                            int organID, int isEnd, int isGive, int incidentSubType) {
        this.incidentFlowID = incidentFlowID;
    ...
    public YjxtIncidentflow() {
    }

    @Override
    public String toString() {
        return "YjxtIncidentflow{" +
                "incidentFlowID='" + incidentFlowID + '\'' +
                ...
                ", placeType=" + placeType +
                ", incidentOther='" + incidentOther + '\'' +
                ", incidentX='" + incidentX + '\'' +
                ", incidentY='" + incidentY + '\'' +
                ", isWatchCCTV=" + isWatchCCTV +
                ", organID=" + organID +
                ", isEnd=" + isEnd +
                ", isGive=" + isGive +
    ...
    public String getIncidentFlowID() {
        return incidentFlowID;
    }

    public void setIncidentFlowID(String incidentFlowID) {
        this.incidentFlowID = incidentFlowID;
    }
}
